...
Some definitions
<div ><div >😴</div><div >**Non-24-Hour Sleep–Wake Disorder **is a condition where your internal “body clock” runs a bit longer than the normal 24-hour day. Because of that, your natural bedtime drifts a little later each night—maybe by 30 minutes, an hour, or more—so over days or weeks your sleep schedule slowly shifts around the clock. </div></div>
...
<div class="kg-card kg-callout-card kg-callout-card-blue"><div class="kg-callout-emoji">💡</div><div class="kg-callout-text">Anhedonia is the state of feeling little or no pleasure from activities or relationships that used to be enjoyable.</div></div>
...
<div ><div >😜</div><div >None of this is medical advice but **personal experience**</div></div>
### The good
...
![Image](/assets/images/2025/09/image.png)
...
<div ><div >💭</div><div >**Change 1 - Plan Earlier**
...
<div ><div >💭</div><div >**Change 2 - Assume forgetfulness**
...
<div ><div >💭</div><div >**Change 3 - Stick to what works**
...
<div ><div >💭</div><div >**Change 4 - Do not compensate to generate drive.**
...
<div ><div >💭</div><div >**Change 5 - Don't estimate lenght of time on a simple liked task based on old-unmedicated you levels of motivation. Give priority to your main task.**
...
<div class="kg-card kg-callout-card kg-callout-card-blue"><div class="kg-callout-emoji">⚠️</div><div class="kg-callout-text">I'm not a neurologist</div></div>
...
![Image](/assets/images/2025/09/image-1.png)
...
<div class="kg-card kg-callout-card kg-callout-card-blue"><div class="kg-callout-emoji">💡</div><div class="kg-callout-text">From now on assume MPX refers to Medikinet/methylphenidate and LSD refers to Elvanse/lisdexhamphetamine</div></div>
...
<div class="kg-card kg-callout-card kg-callout-card-blue"><div class="kg-callout-emoji">⚠️</div><div class="kg-callout-text">I'm not a a pharmacyst, nor a psychiatrist, nor a neurologyst, I'm just an ADHDer of inatentive presentation trying to make sense of what works and what doesn't for me. </div></div>
...
<div ><div >3️⃣</div><div >**My 3 ADHD issues**
1. Sleep disorders
...
<div ><div >💭</div><div >**Change 6 - Prioritise sun over meds **
...
<div ><div >💭</div><div >**Change 7 - Prioritise distractions you can't shake even medicated.**
...
<div ><div >💭</div><div >**Change 8 - First thing of the day: MOVE**
...
<div ><div >💭</div><div >**Change 9 - Block, block, block during working hours**
...
<div ><div >🫰</div><div >I'm not selling you anything at all. Not now, not ever, but eventually, since this blog costs money I'll have to figure a way to fund it. The fediverse extension of Ghost.io requires a paid membership unless one has the time (and patience) to install and configure its own server. 
